    ...
    <>
      ...
      <section className="py-5">
        <div className="container">
          ...
          <p>
            We assess and audit current processes to uncover opportunities for
            improvement and design customized solutions to address them. By
            leveraging advanced technologies such as process control systems and
            automation software, we help digitize and enhance operations for
            greater efficiency. With specialized expertise in design, we deliver
            cost-effective solutions that ensure desired outcomes and long-term
            value.
          </p>
        </div>
      </section>
      ...
      >
        <div className="container text-center">
          <h3 className="fw-bold">
            Looking for a Process Engineering partner?
          </h3>
          <p className="lead">
