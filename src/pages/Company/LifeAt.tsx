    ...
    <section className="life-section py-5">
      <div className="container">
        <div className="text-center mb-4">
          <h2 className="section-title text-primary">Life at <span className="brand-name">Actualize</span></h2>
          <p className="lead text-muted">Where innovation, collaboration, and growth thrive together.</p>
        </div>
        ...
        <div className="life-grid">
          <div className="life-card">
            ...
            <div className="life-content">
              ...
              <p>We foster an inclusive environment where every idea matters.</p>
            </div>
          </div>
          ...
          <div className="life-card">
            ...
            <div className="life-content">
              ...
              <p>Flexible schedules, wellness programs, and meaningful work.</p>
            </div>
          </div>
          ...
          <div className="life-card">
            ...
            <div className="life-content">
              ...
              <p>We empower employees to solve real-world challenges creatively.</p>
            </div>
          </div>
        </div>
      </div>
