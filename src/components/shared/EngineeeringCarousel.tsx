    ...
    <section className="container">
      <div className="text-center mb-4">
        ...
        <p className="lead text-muted">
          We offer a wide range of electrical, mechanical, and plant engineering
          services to help optimize product functioning, improve efficiency, and
            ...
            <div className="row justify-content-center h-20">
              <div className=" carousel-slide col-md-3 col-sm-6  d-flex justify-content-center align-center h-20 ">
                <div className=" highlight-card text-center d-flex flex-column align-items-stretch w-100 ">
                  ...
                  />
                  <h5 style={{ fontWeight: "500", fontSize: "1.5rem" }}>
                    {item.title}
                  </h5>
                  <p style={{ fontWeight: "500", fontSize: "1.0rem" }}>
                    {item.description}
                  </p>
                </div>
              </div>
